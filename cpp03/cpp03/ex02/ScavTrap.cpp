...
/*   Updated: 2024/11/24 03:54:35 by ihajouji         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ScavTrap::attack(const std::string &target)
{
    if (!hit_points)
    {
        std::cout << "\033[32m" << "ScavTrap " << "\033[0m" << name << " tried to attack but couldn't due to lack of hit points" << std::endl;
        return;
    }
    else if (!energy_points)
    {
        std::cout << "\033[32m" << "ScavTrap " << "\033[0m" << name << " tried to attack but couldn't due to lack of energy points" << std::endl;
        return;
    }
