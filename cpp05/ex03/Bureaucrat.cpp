...
/*   Updated: 2025/01/01 04:47:42 by ihajouji         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (obj.getSGrade() < this->getGrade())
        std::cout << this->getName() << " cannot sign " << obj.getName() << " because his grade is too low" << std::endl;
    else
    {
        obj.beSigned(*this);
